...
<html>
    ...
    <body>
        ...
        <header>
            <div id="logo">
                <img src="img/logo.png" alt="cpiprodesign" id="imagen">
            </div>
            <div id="datos">
                <p id="encabezado">
                    <b>Cpiprodesign</b><br>lima, Perú<br>Telefono:(+51)935667172<br>Email: cpiprodesign.com
                </p>
            </div>
            <div id="fact">
