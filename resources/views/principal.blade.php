...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="{{ route('logout') }}"
                            onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i
                                class="fa fa-lock"></i> Cerrar sesión</a>
    ...
    <button type="submit">Cerrar Sesión</button>
        ...
        <footer class="app-footer">
            <span><a href="http://www.cpiprodesign.com/">Cpiprodesign</a> &copy; 2025</span>
            <span class="ml-auto">Desarrollado por <a href="http://www.cpiprodesign.com/">cpiprodesign</a></span>

        </footer>
        <div id="whatsapp">
            <a href="https://wa.link/8ykkof" target="_blank">
                <svg width="80" height="80" xmlns="http://www.w3.org/2000/svg"
                    xmlns:svg="http://www.w3.org/2000/svg">
                    <!-- Created with SVG-edit - https://github.com/SVG-Edit/svgedit-->
                    <g class="layer">
                        <title></title>
                        <circle cx="40" cy="40" fill="#fff" id="svg_1" r="38" stroke="#000000"
                            stroke-width="0" />
                        <path
