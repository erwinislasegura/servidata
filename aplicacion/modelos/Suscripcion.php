...
class Suscripcion extends Modelo
{
    ...
    public function actualizarPlanSuscripcion(int $suscripcionId, int $planId, string $observaciones): void
    {
        $this->db->prepare('UPDATE suscripciones SET plan_id = :plan_id, observaciones = :observaciones, fecha_actualizacion = NOW() WHERE id = :id')->execute([
            'id' => $suscripcionId,
            'plan_id' => $planId,
    ...
    public function extenderVigencia(int $suscripcionId, string $fechaVencimiento, string $observaciones): void
    {
        $this->db->prepare('UPDATE suscripciones SET estado = "activa", fecha_vencimiento = :fecha_vencimiento, observaciones = :observaciones, fecha_actualizacion = NOW() WHERE id = :id')->execute([
            'id' => $suscripcionId,
