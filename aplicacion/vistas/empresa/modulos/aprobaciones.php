...
<div class="card">
    <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
        ...
        <form method="GET" class="d-flex flex-wrap gap-2 align-items-center">
            <input name="q" class="form-control form-control-sm" style="max-width: 220px" value="<?= e($buscar ?? '') ?>" placeholder="Buscar">
            <select name="estado_aprobacion" class="form-select form-select-sm" style="max-width: 180px">
