...
<div class="col-md-4"><label class="form-label">Máximo usuarios</label><input class="form-control" name="maximo_usuarios" type="number" value="<?= e((string)($plan['maximo_usuarios'] ?? 1)) ?>"></div>
<div class="col-md-4"><label class="form-label">Color visual</label><input class="form-control" name="color_visual" value="<?= e($plan['color_visual'] ?? '#0d6efd') ?>"></div>
